...
# phone with rocket photo (default). For sky/smoke footage: --mode launch
...
| `python -m scripts.run_webcam` | Live webcam — default tracks a phone showing a rocket photo |
